...
%Part 1: question a:thermal velocity calculation
vth=sqrt(2*kB*T/mn);%thermal velocity
N=5; %number of particles
deltaT=5*10^-15;
tTotal=1000*deltaT;

%Part 1: question b: MFP
...
for t = 0 : deltaT : tTotal    
    ...
    %Part 1, question c i):2-D plot of particle trajectories
    figure(1);
    plot(xPos,yPos,'.');
    hold on;
    xlim([0 L]);
    ...
    %Part 1, question c ii): Temperature plot
    figure(2);
    xlabel('Time(s)');
